                ...
                this.tischplanService.sendInformation(newInformation)
                    ...
                    if (Information === null) {
                        ...
                        if (Information.tables[0].department === "Bauernstube") {
                            _this.tablesBauernstube[Information.tables[0].arrayIndex] = Information.tables[0];
                        }
                        else if (Information.tables[0].department === "waeldlerStubeKristallStube") {
                            _this.tablesWaeldlerStubeKristallStube[Information.tables[0].arrayIndex] = Information.tables[0];
                        }
                        else if (Information.tables[0].department === "berglerStubeHubertusStube") {
                            _this.tablesBerglerStubeHubertusStube[Information.tables[0].arrayIndex] = Information.tables[0];
                        }
                        else if (Information.tables[0].department === "edelweissKaminStube") {
                            _this.tablesEdelweissKaminStube[Information.tables[0].arrayIndex] = Information.tables[0];
                        }
                        else if (Information.tables[0].department === "teestubeTeelounge") {
                            _this.tablesTeestubeTeelounge[Information.tables[0].arrayIndex] = Information.tables[0];
                        }
                    }
                });
            }
