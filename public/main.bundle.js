...
module.exports = "<div class=\"row4\">\n  <div class=\"col-md-2 col-xs-2\" style=\"height: 50px; width: 16.6%;\" (click)=\"showBauernStubn()\" [ngStyle]=\"{'background-color': '#' + buttonBgColor1}\">\n    <h6 [ngStyle]=\"{'color': '#' + fontColor1}\">Bauernstube</h6>\n  </div>\n  <div class=\"col-md-2 col-xs-2\"  style=\"height: 50px; width: 16.6%;\" (click)=\"showBergler()\" [ngStyle]=\"{'background-color': '#' + buttonBgColor2}\">\n    <h6 [ngStyle]=\"{'color': '#' + fontColor2}\">Berglerstube<br>HUBERTUS Stube</h6>\n  </div>\n  <div class=\"col-md-2 col-xs-2\" style=\"height: 50px; width: 16.6%;\" (click)=\"showWaeldler()\" [ngStyle]=\"{'background-color': '#' + buttonBgColor3}\">\n    <h6 [ngStyle]=\"{'color': '#' + fontColor3}\">Wäldlerstube<br>Kristallstube</h6>\n  </div>\n  <div class=\"col-md-2 col-xs-2\" style=\"height: 50px; width: 16.6%;\" (click)=\"showEdelweiss()\" [ngStyle]=\"{'background-color': '#' + buttonBgColor4}\">\n    <h6 [ngStyle]=\"{'color': '#' + fontColor4}\">EDELWEISS<br>Kaminstube</h6>\n  </div>\n  <div class=\"col-md-2 col-xs-2\" style=\"height: 50px; width: 16.6%;\" (click)=\"showTeestube()\" [ngStyle]=\"{'background-color': '#' + buttonBgColor5}\">\n    <h6 [ngStyle]=\"{'color': '#' + fontColor5}\">TeeStube<br>Teelounge</h6>\n  </div>\n  <div class=\"col-md-2 col-xs-2\" style=\"height: 50px; width: 16.9%;\" (click)=\"showAlle()\" [ngStyle]=\"{'background-color': '#' + buttonBgColor6}\">\n    <h6 [ngStyle]=\"{'color': '#' + fontColor6}\">Alle</h6>\n  </div>\n</div>\n"
