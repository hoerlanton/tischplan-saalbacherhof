export class Table {
  ...
  bemerkungValue9: string;
  bemerkungValue10: string;
  bemerkungValue11: string;
  nameValue5: string;
  ...
  notiz10Value: string;
  trace5: string;
  bemerkungValue12: string;
  bemerkungValue13: string;
  bemerkungValue14: string;
  nameValue6: string;
  ...
  notiz12Value: string;
  trace6: string;
  bemerkungValue15: string;
  bemerkungValue16: string;
  bemerkungValue17: string;
  nameValue7: string;
  ...
  notiz14Value: string;
  trace7: string;
  bemerkungValue18: string;
  bemerkungValue19: string;
  bemerkungValue20: string;
  newTraceText: string;
